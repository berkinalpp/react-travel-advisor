        ...
        <Card elevation = {10}>
            ...
            <CardContent>
                ...
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Chip key={place.rating} size="small" label={place.rating} className={classes.chip} style={{backgroundColor:'#3F51B5', color:'#fff',padding:'7px', fontSize:'15px'}} />
                </Box>
                {place?.awards?.map((award,key) => (
                    <Box my={1} key={key} display="flex" justifyContent="space-between" alignItems="center">
                ...
                {place?.cuisine?.map(({name},key) => (
                    ...
                    <CardActions>
                        ...
                        <Button size="small" color="primary" onClick={() => window.open(place.website,'_blank')}>Web Site</Button>
